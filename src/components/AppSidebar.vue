<template>
    <header class="sidebar shadow">
        ...
        <div class="p-4">
            <a href="https://twitter.com/gopalkildoliya" target="_blank">
        ...
        <div class="p-4">
            <a href="https://www.buymeacoffee.com/gopal" target="_blank"><img src="https://img.buymeacoffee.com/api/?name=Gopal+Lal&size=48&bg-image=bmc" alt="Buy Me A Coffee" style="border-radius: 50%" class="img-fluid" ></a>
        </div>
